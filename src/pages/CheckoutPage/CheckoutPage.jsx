...
const PaymentPage = () => {
  ...
  const handleChangeMethodShipping = (event) => {
    setMethodShipping(event.target.id === 'radio_2'); // Kiểm tra id của input radio để xác định giá trị của methodShipping
  };
  ...
  return (
    <>
      ...
      <div className='flex flex-col items-center border-b bgWhite py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32'>
        <a href='#' className='text-2xl font-bold text-cyan-700'>
          Thanh toán dễ dàng với CANIFA
        </a>
      ...
      <div className='grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32'>
        ...
        <div className='mt-10 bg-gray-50 px-4 pt-8 lg:mt-0'>
          ...
          <div className=''>
            ...
            <div className='mt-6 border-t border-b py-2'>
              ...
              <div className='flex items-center justify-between'>
                ...
                <p className='font-semibold text-gray-900'>${methodShipping ? '88' : '20'}</p>
              </div>
            </div>
          ...
          <Button variant='contained' fullWidth sx={{ my: 4 }} size='large'>
            <Link to='/checkout-success'>Thanh toán</Link>
          </Button>
        </div>
      </div>
    </>
